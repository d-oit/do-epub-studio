...
// Upstream independently built `plugins/transformers-editorial.ts` and closed
// B1 earlier (2026-09-23, items 3/5 green on 0.5B q8), with the labelled
// download UI, draw caps and echo detector this branch's prototype lacked.
// Its rows are kept as the record of record; this branch's independent
// implementation and evidence are noted in the AI-03 row of plan 999.
