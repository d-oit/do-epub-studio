...
**Status:** IN PROGRESS (A-track A1–A3 merged; **B1 DONE 2026-09-23** — live corpus items 3/5 green, bundle/sw verified; item 6 story/logic residual → B2 row)
**Date:** 2026-09-22
...
| 5 | **B2 — Story/logic milestone flip** with the same evidence discipline as A3 | Evidence recorded; flip is reviewable and category-scoped | READY (deps B1 met 2026-09-23; residual: live item 6 contract — start with `E2E_DIAG_ITEM=6` raw-output diagnosis before any prompt/decoding proposal) |
