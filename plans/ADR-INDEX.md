...
| 284    | Book-scoped invitation and account lifecycle | `plans/284-adr-invitation-account-lifecycle.md` | Accepted (GOAP-284; implementation in progress) |
...
| 276    | External harness benchmark adoption — GOAP plan | `plans/276-goap-external-harness-benchmark-adoption.md` | PROPOSED — Phase 0 COMPLETE (2026-09-24): all seven P0 items closed via #1197 (items 1–3), #1203 (4), #1205 (6), #1204 (7), #1208 (5); Phases 1–2 still open |
