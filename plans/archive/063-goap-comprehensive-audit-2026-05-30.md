...
**Companion ADR:** `plans/063-adr-comprehensive-audit-policy.md` ✅ Created — establishes recurring audit cadence
...
| D6  | P2       | Docs | **Plan archive README** references plan 049 but may be stale after recent archival                                                                            | `plans/archive/README.md`                  |
...
Wave 1 additional gates: 6. Lighthouse accessibility score ≥ 0.85 (already set in `.lighthouserc.json`) 7. Axe-core audits: 0 critical/serious violations on all pages 8. Color contrast verification for all `foreground-muted` usages
...
- Companion ADR `plans/063-adr-comprehensive-audit-policy.md` created — defines bi-weekly audit cadence, 10-category scope, swarm methodology, and wave-based execution.
