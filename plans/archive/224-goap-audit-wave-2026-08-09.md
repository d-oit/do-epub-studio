...
- [x] W3.2: LRU cache HIT resolves from the serialized-string cache _without_
  ...
  - **Note (2026-08-10 verify):** the original AC line was "LRU cache HIT does not
    ...
    resolves from the serialized-string cache and _does_ re-parse via a browser-native
