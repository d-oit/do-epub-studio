...
| --- | ------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| B1  | **P1** | `apps/worker/src/routes/admin/grants.ts:72-99` (PATCH) vs `:112-124` (revoke)                                                                                                     | **TIER-1 violation:** grant _updates_ (`mode`, `comments_allowed`, `offline_allowed`, `expires_at`) do **not** revoke active `reader_sessions`; only explicit revoke does. AGENTS.md requires "revoke sessions immediately on grant change." A downgraded grant leaves elevated sessions live. |
