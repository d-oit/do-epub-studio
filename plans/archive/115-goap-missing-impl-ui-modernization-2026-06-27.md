...
| U4  | P3     | [globals.css:77](file:///home/doit/do-epub-studio/apps/web/src/styles/globals.css#L77)                                                                                                      | **overused-font** `Geist` — PRODUCT.md/DESIGN.md call for an _editorial_ serif/sans pairing, not a generic AI-default sans      | Decide deliberately: either commit to a serif display + humanist body pairing (matches "book app, not SaaS" brand), or document Geist as an intentional choice to silence the rule |
