...
export function registerLogin(router: AuthApp): void {
  ...
  router.post('/login/mfa/start', zValidator('json', LoginMfaStartSchema), async (c) => {
  ...
  router.post('/login/mfa/verify', zValidator('json', LoginMfaVerifySchema), async (c) => {
  ...
  router.post('/login/mfa/recovery-verify', zValidator('json', RecoveryVerifyLoginSchema), async (c) => {
