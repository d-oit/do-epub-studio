...
describe('epub-validator', () => {
  ...
  it('should warn for non-EPUB 3 versions', async () => {
    ...
    zip.file(
      'content.opf',
      '<?xml version="1.0"?><package version="2.0" xmlns="http://www.idpf.org/2007/opf"><metadata></metadata><spine></spine></package>',
    );
    ...
    expect(result.warnings).toContain(
      'EPUB version is 2.0. Only EPUB 3.x is officially supported.',
    );
  });
});
