...
const PATH_FIXED_LAYOUT =
  'M4 8V4m0 0h4M4 4l5 5m11-1V4m0 0h-4m4 0l-5 5M4 16v4m0 0h4m-4 0l5-5m11 5l-5-5m5 5v-4m0 4h-4';
const PATH_EXPORT =
  'M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z';
const PATH_SETTINGS_GEAR =
  ...
  return (
    <Tooltip content={label}>
      ...
      >
        ...
        {badge != null && badge > 0 && (
          <span
            className="absolute -top-1 -right-1 w-4 h-4 bg-primary-700 text-background text-[10px] rounded-full flex items-center justify-center font-bold"
            aria-hidden="true"
          >
            {badge}
          </span>
  ...
  return (
    <div className="cq-reader-toolbar-actions items-center gap-1">
      ...
      {isFixedLayout && onToggleFixedLayoutControls && (
        <ToolbarIconButton
          label={t('reader.fixedLayout.title')}
          onClick={onToggleFixedLayoutControls}
          isExpanded={activePanel === 'fl-controls'}
          svgPath={PATH_FIXED_LAYOUT}
        />
      )}
      <ToolbarIconButton
        label={t('reader.exportNotes')}
      ...
      <ToolbarIconButton
        ...
        svgPath={[PATH_SETTINGS_GEAR, PATH_SETTINGS_DOT]}
      />
