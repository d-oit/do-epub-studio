...
# Note: OpenCode reads directly from .agents/skills/ - no symlinks needed.
set -euo pipefail
...
# (Qwen CLI also reads directly from .agents/skills/ via a direct symlink - not included here)
CLI_SKILL_DIRS=(
  ".claude/skills"
)
