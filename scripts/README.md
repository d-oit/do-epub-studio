...
| `check-bundle-budget.mjs` | Unified gzipped bundle budget enforcer per ADR-107 §3 (180 KB main JS / 30 KB main CSS / 100 KB lazy chunk) + boundary rules + route budgets (T4.1) | node |
