...
Items documented in docs/plans/015, 019, and KNOWN-ISSUES.md, confirmed still open:

| #    | Gap                                                                                                                     | Priority | Status                        |
| ---- | ----------------------------------------------------------------------------------------------------------------------- | -------- | ----------------------------- |
| PG-1 | React 18 / Vitest concurrency — some admin/reader test suites skipped                                                   | Medium   | Documented in KNOWN-ISSUES.md |
| PG-2 | ESLint `any` warnings (2 files: `apps/web/src/components/ui/index.tsx:224`, `apps/worker/src/__tests__/cors.test.ts:8`) | Low      | Tracked in docs/plans/015          |
| PG-3 | Tailwind arbitrary value warnings (2 files: `ReaderPage.tsx:766`, `toast.tsx:84`)                                       | Low      | Tracked in docs/plans/015          |
| PG-4 | `reader-state.ts` at 482 LOC (near 500 limit)                                                                           | Monitor  | Tracked in docs/plans/012          |
| PG-5 | `admin.ts` at 465 LOC (near 500 limit)                                                                                  | Monitor  | Tracked in docs/plans/012          |
...
- All docs/plans/015 through 019 — Prior findings
