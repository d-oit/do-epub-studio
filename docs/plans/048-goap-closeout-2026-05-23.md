...
- `#255` touches docs/plans/ directory only
...
| Priority | Medium |
| Deps | None |
| Files | `docs/plans/021-adr-test-infrastructure.md`, `docs/plans/022-adr-coverage-and-benchmarking.md`, `docs/plans/037-adr-agent-harness-improvement-policy.md` |
...
| Files | `docs/plans/` directory |

**Status:** Move plans 000-030 to `docs/plans/archive/`. Create archive policy doc.
...
- Move plans 000-030 to docs/plans/archive/
- Create docs/plans/archive/README.md with archival policy
...
| #251 | `fix/issue-251-adrs` | `docs/plans/021-*, 022-*, 037-*` |
