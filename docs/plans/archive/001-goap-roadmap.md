...
1. **Foundation Refresh**
   - Update `AGENTS.md`, docs/plans/, and skill library per coding guide.
...
7. **Infrastructure Hardening (Sprint #141)**
   ...
   - See docs/plans/020-goap-sprint-141.md and docs/plans/023-audit-gap-closure.md.

## Phase Guards

- Every phase must reference which TRIZ contradiction(s) it resolves.
- `./scripts/quality_gate.sh` must pass before advancing.
- Update `docs/plans/007-implementation-phases.md` after each completed slice.
