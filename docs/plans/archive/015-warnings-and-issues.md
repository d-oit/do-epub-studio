...
Three stricter rules enabled as `warn` in PR #189. See `docs/plans/040-goap-warnings-and-issues-2026-05-19.md` for full breakdown.
...
All CI runs on `main` fail with "workflow file issue" — likely GitHub Actions runner infrastructure. See `docs/plans/040-goap-warnings-and-issues-2026-05-19.md` CI-W1.
...
- `docs/plans/010-optimization-quality-backlog.md` - Quality improvements backlog
- `docs/plans/012-comprehensive-analysis-findings.md` - Full analysis
