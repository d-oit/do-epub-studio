...
**Related ADR:** `docs/plans/052-adr-gap-closure-policy.md`

## Goal

Close all 12 gaps (G1-G12) identified in `docs/plans/052-goap-codebase-gap-analysis.md` and document remaining pre-existing CI failures.
...
| `docs/plans/028-*.md` | Table column count mismatch | Added missing column header |
| `docs/plans/035-adr-content-security-policy.md` | List marker spacing | Fixed double space after markers |
| `docs/plans/033-*.md` | Table missing trailing pipe | Added trailing pipe |
...
| `docs/plans/archive/011-*.md` | Multiple blank lines | Removed extra blank line |
