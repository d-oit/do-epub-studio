...
| ID | File | Fix | Agent |
|----|------|-----|-------|
| A1 | `docs/plans/020-goap-sprint-141.md` | Fix NODE22→NODE24 contradiction in task 1.2 text | general |
...
| ID | File | Fix | Status |
|----|------|-----|--------|
| A1 | `docs/plans/020-goap-sprint-141.md` | Fix NODE22→NODE24 contradiction in task description | ✅ |
