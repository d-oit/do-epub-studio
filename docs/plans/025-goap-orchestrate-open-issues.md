...
### Current Phase (from docs/plans/007-implementation-phases.md)
...
- Existing docs/plans/ follow this pattern (020-goap-sprint-141.md, 024-adr-warning-management.md)
...
### References
- docs/plans/020-goap-sprint-141.md – GOAP sprint pattern
- docs/plans/024-adr-warning-management.md – ADR template
