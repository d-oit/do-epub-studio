...
| `docs/plans/036-goap-template-ai-agents-improvements.md` | Added status: ✅ Superseded |
| `docs/plans/041-pr-merge-session-2026-05-20.md` | Added status: ✅ Completed |
| `docs/plans/043-adr-learnings-compaction-policy.md` | Added status: ✅ Accepted |
| `docs/plans/045-goap-batch-resolve-issues-223-225-226-236-and-prs-232-235-237.md` | Added status: ✅ Completed |
| `docs/plans/050-goap-swarm-progress-update.md` | Added status: ✅ Completed |
| `docs/plans/archive/049-goap-swarm-all-open-issues.md` | Wave statuses: pending→superseded |
| `docs/plans/062-goap-final-remaining-tasks.md` | Created (this plan) |
