...
Implement all remaining missing tasks identified across docs/plans/ analysis.
...
| T5 | P1 | Finalize CSP ADR from Proposed→Accepted | `security-code-auditor` | `docs/plans/035-adr-content-security-policy.md` |
| T6 | P1 | Update CI composite actions for Node.js 24 compatibility | `cicd-pipeline` | `.github/actions/` |
| T7 | P2 | Plan 007 Phase 8 pointer / plan status sync | `agents-md` | `docs/plans/` |
...
| T5 | P1 | Finalize CSP ADR from Proposed→Accepted | `security-code-auditor` | ✅ Merged — status updated in `docs/plans/035-adr-content-security-policy.md` |
