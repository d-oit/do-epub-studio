...
- "After any change, run diagnostics and document any new warnings in `docs/plans/015-warnings-and-issues.md` or `agents-docs/KNOWN-ISSUES.md`"
...
| ------------ | ------------------------------------------------------------------ | -------------------------------------- | -------------- |
| **Active**   | Currently impacting development, fix planned within next 2 sprints | `docs/plans/` — GOAP sprint plan tasks      | Each sprint    |
...
- `docs/plans/015-warnings-and-issues.md` — Historical tracking
- `docs/plans/020-goap-sprint-141.md` — Sprint remediation targets
