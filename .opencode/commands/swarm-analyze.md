...
Perform a comprehensive swarm analysis of the codebase using the
...
3. **Documentation Gaps** - Undocumented APIs, complex logic, setup
   instructions
...
Also identify quick wins, issues confirmed by multiple perspectives, and
